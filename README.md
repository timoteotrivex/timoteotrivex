...
Data Analyst en formación, enfocado en SQL Server y Power BI, 

Construyo proyectos end-to-end: desde la consulta SQL hasta el dashboard final, 
usando siempre el mismo dataset (AdventureWorks2022) para mostrar cómo se conecta 
todo el flujo de análisis de datos.
